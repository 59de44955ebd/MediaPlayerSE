    ...
    def get_metadata(self):
        ...
        while True:
            ...
            if not fetched:
                break
            try:
                media_content = filt.QueryInterface(IAMMediaContent)
                res = {}
                try:
                    res['author'] = media_content.get_AuthorName()
                except:
                    pass
                try:
                    res['title'] = media_content.get_Title()
                except:
                    pass
                try:
                    res['description'] = media_content.get_Description()
                except:
                    pass
                return res
            except:
